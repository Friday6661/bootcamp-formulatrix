...
namespace SnakesAndLadders
{
    partial class Program
    {
        static void Main(string[] args)
        {
            ...
            int playerCount = GetInputNumberPlayers(gameControl);
            GetInputPlayerName(gameControl, playerCount);
            DrawBoard(gameControl);
            int boardSetup = GetBoardFromUser(gameControl);
            int diceSetup = GetDiceFromUserInput(gameControl);
            Console.Clear();
            Console.WriteLine("===========[Main Program]===========");
            Console.WriteLine("Number of players: " + playerCount);
            GetPlayerInfo(gameControl);
